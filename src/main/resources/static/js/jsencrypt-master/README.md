...
This library should work hand-in-hand with openssl.  With that said, here is how to use this library.
 ...
 - Within your terminal (Unix based OS) key the following.
...
- Also, unless you use a custom hash function, you should provide the hash key to the `sign` method. Possible values are: `md2`, `md5`, `sha1`, `sha224`, `sha256`, `sha384`, `sha512`, `ripemd160`.
